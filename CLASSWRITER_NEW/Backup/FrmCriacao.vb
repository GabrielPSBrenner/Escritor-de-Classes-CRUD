...
#End Region
   ...
   Public NomeArquivoXML As String
	...
	Private _ConnectionString As String = "Server=" & Server & ";DataBase=" & DataBase & ";UID=" & UID & ";PWD=" & PWD
   ...
   End Sub
	...
	Private Sub CRIAXML()
		...
		If UsaCaminhoPadrao Then
			NomeArquivo = "C:\Projetos\XML\" & NomeArquivoXML & ".xml"
		Else
		...
		End If
		strm.WriteLine("    <ConnectionString><![CDATA[" & _ConnectionString & "]]></ConnectionString>")
		strm.WriteLine("  </Connection>")
		...
		For i = 0 To Items.Count - 1
			...
			For x = 0 To Tabela.TotalCampos - 1
				...
				If Tabela.Campos(x).Chave = True Then
					strField += " Id=""PK""" & " "
				ElseIf Tabela.Campos(x).ChaveEstrangeira Then
					strField += " Id=""FK""" & " "
				Else
					strField += " Id=""""" & " "
				End If
   ...
   Private Sub CriaArquivosClassesVBNET()
      ...
      If CRUDMODEL Then
         ...
         Dim str As String = sr.ReadToEnd()
			...
			If UsaCaminhoPadrao Then
				str = str.Replace("[Caminho]", "C:\Projetos\XML\" & NomeArquivoXML & ".xml")
			Else
				str = str.Replace("[Caminho]", Diretorio & NomeArquivoXML & ".xml")
			End If
         strm.Write(str)
         strm.Close()
