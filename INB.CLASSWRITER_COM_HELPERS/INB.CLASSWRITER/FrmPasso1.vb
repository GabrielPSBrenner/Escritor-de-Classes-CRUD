...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
		...
		'FamSQLSERVER
		'
		Me.FamSQLSERVER.Controls.Add(Me.txtConnectionString)
		...
		Me.FamSQLSERVER.Size = New System.Drawing.Size(540, 123)
		Me.FamSQLSERVER.TabIndex = 2
		'
		'txtConnectionString
		'
		Me.txtConnectionString.Location = New System.Drawing.Point(68, 92)
		Me.txtConnectionString.MaxLength = 2000
		Me.txtConnectionString.Name = "txtConnectionString"
		Me.txtConnectionString.Size = New System.Drawing.Size(464, 20)
		Me.txtConnectionString.TabIndex = 10
		'
		'ChkTrusted
		'
		...
		'CmdAvancarPasso2
		'
		Me.CmdAvancarPasso2.Location = New System.Drawing.Point(448, 173)
		...
		'CmdFinalizar
		'
		Me.CmdFinalizar.Location = New System.Drawing.Point(344, 173)
		...
		Me.ClientSize = New System.Drawing.Size(556, 206)
...
#End Region
	...
	Private Sub FrmPasso1_Load(sender As Object, e As EventArgs) Handles Me.Load
		CboTipoConexao.Items.Add("SQL-SERVER")
		CboTipoConexao.SelectedIndex = 0
		BindingControls(False)

		Dim oPlaceHolder = New Placeholder(txtConnectionString, "ou cole aqui a connection string".ToUpper)
	End Sub
	...
	Private Sub txtConnectionString_LostFocus(sender As Object, e As EventArgs) Handles txtConnectionString.LostFocus
		Try
			Dim strCn As System.Data.SqlClient.SqlConnectionStringBuilder = New System.Data.SqlClient.SqlConnectionStringBuilder(txtConnectionString.Text)
			TxtPWD.Text = strCn.Password
			TxtUID.Text = strCn.UserID
			TxtServidor.Text = strCn.DataSource
			TxtBancoDados.Text = strCn.InitialCatalog
		Catch ex As Exception
